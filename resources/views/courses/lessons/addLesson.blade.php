...
<div class="col-12 p-3">
    <div class="col-12 col-lg-12 p-0 ">
        <form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.lesson.add')}}">
            @csrf
            <div class="col-12 col-lg-8 p-0 main-box">
                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <select class="form-control select2-select" name="course_id" required size="1" style="height:30px;opacity: 0;">
                                ...
                                <option value="{{$c->id}}" @selected($course->id == $c->id)>{{$c->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="video" required maxlength="190" class="form-control" value="{{old('video')}}">
                        </div>
                    </div>
