...
<body class="" id="top">
    <div class=" pt-2 pb-2 bg-green ">
        <p class="ps-5 text-light h4">موقع الهاشمى التعليمي</p>
    </div>

    <section id="list-services">
        <div class="container">
            <h5 class="text-oringe">سياسة الخصوصية الخاص بتطبيق أكسفورد</h5>
            <ul class="list-group">
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يركز تطبيق أكسفورد على مساعدة طلاب المدارس في عدد من الدول العربية، من خلال تقديم شروح مبسطة للمناهج الدراسية، من المرحلة الابتدائية، وحتى المرحلة الثانوية.
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يتح تطبيق أكسفورد للطلاب الراغبين في التعلم عبر الإنترنت، عددًا كبيرًا من المواد الدراسية مثل مادة الكيمياء و الفيزياء وغيرها من المواد.
                            </p>
