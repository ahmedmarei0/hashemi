...
<body class="" id="top">
    ...
    <section id="list-services">
        <div class="container">
            <h5 class="text-oringe">سياسة الخصوصية</h5>
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                تتيح المنصة، للطلاب الراغبين في التعلم عبر الإنترنت، عددًا كبيرًا من المواد الدراسية مثل مادة الكيمياء و الفيزياء وغيرها من المواد.
                            </p>
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                تعتمد المنصة على نظام الاشتراك فى المواد الدراسية التى تريد البداء فى الدراسة فيها من باقة لكل مادة دراسية او مجموعة موادة دراسة او حتى حساب بريم
                            </p>
