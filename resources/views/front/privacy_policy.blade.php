...
<head>
    ...
    <meta name="title" content="الهاشمى">
    <meta name="description"
        content="عرض شروحات المواد بأحدث الاساليب والطرق الحديثة، أساتذة على اعلى مستوي وكفاءة معك دائما لتكون متفوق">
...
<body class="" id="top">
    <div class=" pt-2 pb-2 bg-blue ">
        <p class="ps-5 text-light h4">تطبيق فراداي </p>
    </div>

    <section id="list-services">
        <div class="container">
            <h5 class="text-oringe">سياسة الخصوصية الخاص بتطبيق فراداي</h5>
            <ul class="list-group">
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يركز تطبيق فراداي على مساعدة طلاب المدارس في عدد من الدول العربية، من خلال تقديم شروح مبسطة للمناهج الدراسية، من المرحلة الابتدائية، وحتى المرحلة الثانوية.
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يتيح تطبيق فراداي للطلاب الراغبين في التعلم عبر الإنترنت،يكون الأشتراك عبر الأشتراك عن طريق أدارة تطبيق فراداي و دفع اشتراك مقابل الخدمة ويتيح للمستخدم عددًا كبيرًا من شروحات المواد الدراسية مثل مادة الكيمياء و الفيزياء وغيرها من المواد .
                            </p>
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يعتمد تطبيق فراداي على نظام الاشتراك فى المواد الدراسية التى تريد البدء فى الدراسة فيها من باقة لكل مادة دراسية او مجموعة موادة دراسة او حتى حساب بريم
                            </p>
