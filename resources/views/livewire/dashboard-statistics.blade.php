                ...
                <div class="col-12 p-3 row d-flex">
                    ...
                    <div class="col-4 d-flex justify-content-center align-items-center mb-3 py-2">
                        <a href="{{route('admin.settings.index')}}" style="color:inherit;">
                            <div class="col-12 p-0 text-center">
                                <img src="{{ asset('images/icons/settings.png') }}" style="width:30px;height: 30px">
                    ...
                    <div class="col-4 d-flex justify-content-center align-items-center mb-3 py-2">
                        <a href="{{route('admin.profile.index')}}" style="color:inherit;">
                            <div class="col-12 p-0 text-center">
                                <img src="{{ asset('images/icons/man.png') }}" style="width:30px;height: 30px">
                    ...
                    <div class="col-4 d-flex justify-content-center align-items-center mb-3 py-2">
                        <a href="{{route('admin.profile.index')}}" style="color:inherit;">
                            <div class="col-12 p-0 text-center">
                                <img src="{{ asset('images/icons/edit.png') }}" style="width:30px;height: 30px">
                    ...
                    <div class="col-4 d-flex justify-content-center align-items-center mb-3 py-2">
                        <a href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();"
                            ...
                            <div class="col-12 p-0 text-center">
                                ...
                                <img src="{{ asset('images/icons/logout.png') }}" style="width:30px;height: 30px">
            ...
            <div class="col-12 p-0 main-box">
                ...
                <div class="col-12 p-3">
                    ...
                    <div class="col-12 px-2 py-1 row">
                        <div class="col-4 p-0">
                            <span style="width: 30px;height: 17px;font-weight: bold;background: #0194fe;color: #fff;"
                                class="badge badge-light d-flex align-items-center justify-content-center">
                                {{$page->count}}
                            </span>
                        </div>
                    ...
                    <div class="col-12 px-2 py-1 row">
                        ...
                        <div class="col-8 text-truncate p-0" style="direction:ltr;font-size: 12px;">
                            <a href="//{{$main_domain->main_domain}}" target="_blank" style="color:inherit">
                                <img src="https://icons.duckduckgo.com/ip3/{{$main_domain->main_domain}}.ico"
                                    style="width:10px;height: 10px;" class="d-inline-block">
                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="col-12 px-2 py-1 row">
                        ...
                        <div class="col-8 text-truncate p-0" style="direction:ltr;font-size: 12px;">
                            ...
                            <span class="fi fi-{{strtolower($country->country_code)}} mx-1"
