        ...
        <div class="col-12 px-0">
            <div class="col-12 p-0 row">
                <div class="col-12 col-lg-4 py-3 px-3">
                    ...
                    @if ($type == null)
                    جميع المستخدمين
                    @elseif ($type == 'active_student')
                    الطلاب النشاطون
                    @elseif ($type == 'blocked_student')
                    الطلاب المحظورون
                    @elseif ($type == 'active_user')
                    المستخدمين النشاطون
                    @elseif ($type == 'blocked_user')
                    المستخدمين المحظورون
                    @endif
                </div>
                    ...
                    <div class="float-end m-1">
                        <div class="dropdown">
                            <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                ...
                                أدارة المستخدمين والطلاب
                            </a>

                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.users.filter.show','active_student') }}">
                                        الطلاب النشاطون
                                    </a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('admin.users.filter.show','blocked_student') }}">
                                        الطلاب المحظورون
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.users.filter.show','active_user') }}">
                                        المستخدمين النشاطون
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.users.filter.show','blocked_user') }}">
                                        المستخدمين المحظورون
                                    </a>
                                </li>
                            </ul>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endpermission
                                <a href="{{route('admin.users.notes.show',$user)}}">
                                    <span class="btn btn-outline-primary btn-sm font-1 mx-1">
